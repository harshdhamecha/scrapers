...
class DubbizleScraper(object):
    ...
    def get_page_info(self):
        divs = WebDriverWait(self.driver, self.short_wait).until(EC.presence_of_all_elements_located((
            By.CSS_SELECTOR, 'div.a52608cc'
        )))
        anchors = [div.find_element(By.TAG_NAME, 'a') for div in divs]
